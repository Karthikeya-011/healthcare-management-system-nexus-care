...
export class LoginComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    $("#userbtn").click(function () {
      ...
      $("#adminbtn").css("border", "0").css("border-bottom", "1.5px solid rgb(6, 50, 53)").css("opacity", "0.3");
      $("#doctorbtn").css("border", "0").css("border-bottom", "1.5px solid rgb(6, 50, 53)").css("border-left", "1.5px solid rgb(6, 50, 53)").css("opacity", "0.3");
    });
  ...
  adminLogin() {
    ...
    this.http.post('http://localhost:8080/loginadmin', admin).subscribe(
      (response: any) => {
